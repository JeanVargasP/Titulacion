            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/ph/' . $ph->id . '/edit') }}" title="Edit Ph"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Descripcion </th><td> {{ $ph->descripcion }} </td></tr><tr><th> Nivel </th><td> {{ $ph->Nivel }} </td></tr>
                                </tbody>
                            </table>
                        </div>
